...
During training, the ResNet34 encoder was initialized with ImageNet-pretrained weights to improve feature extraction.
...
Albumentations was used to ensure that transformations were applied consistently to images and their corresponding segmentation masks.
...
> The trained model checkpoint is hosted with the deployed Hugging Face application rather than duplicated in this GitHub repository.
...
* Evaluating additional segmentation metrics such as Dice Score and F1 Score
