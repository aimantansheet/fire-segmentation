...
Albumentations was used to apply the image transformations consistently with the corresponding segmentation masks.
...
🔥 Fire Segmentation API on Hugging Face
...
is approximately 93 MB and is maintained with the deployed Hugging Face application rather than duplicated in this GitHub repository.

The GitHub repository contains the source code, training notebook, Docker configuration, and documentation.

Model Loading

The inference application expects the trained checkpoint to be available as:
